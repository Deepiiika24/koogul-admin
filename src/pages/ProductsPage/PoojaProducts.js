...
function PoojaProducts() {
  ...
  return (
    <>
      <Helmet>
        <title>PoojaProducts | Koogul Admin</title>
      </Helmet>
      <Container>
        ...
        <Card sx={{ padding: 2, boxShadow: 3, backgroundColor: "#fff" }}>
          ...
          <Dialog open={open} onClose={handleClose}>
            <DialogTitle>Add New PoojaProducts Variety</DialogTitle>
            <DialogContent>
              <TextField margin="dense" label="PoojaProducts Name" name="PoojaProducts Name" fullWidth />
